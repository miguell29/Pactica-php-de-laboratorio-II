            ...
            if (!empty($_GET['buscar'])) {
                ...
                while ($fila = mysqli_fetch_array($resultado)) {
                    ...
                    if ($_SESSION['tipo'] == 'Administrador'){
                        echo '<section class="botones_ud"><figure><a href="modificar_libro.php?id='.$id.'"><img src="../img/modificar.png" alt="modificar libro"></a></figure><figure><a href="eliminar_libro.php?id='.$id.'"><img src="../img/eliminar.png" alt="eliminar libro"></a></figure></section>';
                    }
                    echo '</section>';
                    echo '</article>';                
                }
